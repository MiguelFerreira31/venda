...
<form method="POST" id="form-funcionario" action="http://localhost/venda/public/funcionarios/adicionar" enctype="multipart/form-data">
  <div class="container my-5">
    <div class="row justify-content-center">
      <div class="col-lg-10 glass-form">
        <h2 class="mb-4 text-center fw-bold">Cadastro de Funcionario</h2>
        <div class="row">
          <!-- Nome -->
